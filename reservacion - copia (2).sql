...
CREATE SCHEMA IF NOT EXISTS `treslagunas` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `treslagunas` ;

-- -----------------------------------------------------
-- Table `reservacion`.`c_actividad`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `treslagunas`.`c_actividad` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `treslagunas`.`c_tipousuario` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `treslagunas`.`c_usuario` (
  ...
  CONSTRAINT `c_usuario_fk01`
    ...
    REFERENCES `treslagunas`.`c_tipousuario` (`id_tipoUsuario` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `treslagunas`.`c_estadoreservacion` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `treslagunas`.`p_reservacion` (
  ...
  CONSTRAINT `p_reservacion_fk01`
    ...
    REFERENCES `treslagunas`.`c_usuario` (`id_usuario` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `p_reservacion_fk02`
    FOREIGN KEY (`id_estadoReservacion` )
    REFERENCES `treslagunas`.`c_estadoreservacion` (`id_estadoReservacion` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `treslagunas`.`c_cabania` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `treslagunas`.`c_asignacioncabania` (
  `id_reservacion` VARCHAR(45) NOT NULL ,
  ...
  CONSTRAINT `c_asignacionCabania_fk01`
    ...
    REFERENCES `treslagunas`.`p_reservacion` (`id_reservacion` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `c_asignacionCabania_fk02`
    FOREIGN KEY (`id_cabania` )
    REFERENCES `treslagunas`.`c_cabania` (`id_cabania` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `treslagunas`.`c_asignacionreservacionactividad` (
  `id_reservacion` VARCHAR(45) NOT NULL ,
  ...
  CONSTRAINT `c_asignacionPaquete_fk02`
    ...
    REFERENCES `treslagunas`.`c_actividad` (`id_actividad` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `treslagunas`.`c_paquete` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `treslagunas`.`c_asignacionpaqueteactividad` (
  ...
  CONSTRAINT `c_asignacionPaqueteActividad_fk01`
    ...
    REFERENCES `treslagunas`.`c_paquete` (`id_paquete` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `treslagunas`.`c_turista` (
  `id_usuario` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `treslagunas`.`c_asignacionReservacionPaquete` (
  `id_reservacion` VARCHAR(45) NOT NULL ,
  `id_paquete` INT(11) NOT NULL ,

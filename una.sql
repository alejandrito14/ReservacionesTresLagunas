...
CREATE SCHEMA IF NOT EXISTS `u969528706_una` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `u969528706_una` ;

-- -----------------------------------------------------
-- Table `reservacion`.`c_actividad`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `u969528706_una`.`c_actividad` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `u969528706_una`.`c_tipousuario` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `u969528706_una`.`c_usuario` (
  ...
  CONSTRAINT `c_usuario_fk01`
    ...
    REFERENCES `u969528706_una`.`c_tipousuario` (`id_tipoUsuario` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `u969528706_una`.`c_estadoreservacion` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `u969528706_una`.`p_reservacion` (
  ...
  CONSTRAINT `p_reservacion_fk01`
    ...
    REFERENCES `u969528706_una`.`c_usuario` (`id_usuario` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `p_reservacion_fk02`
    FOREIGN KEY (`id_estadoReservacion` )
    REFERENCES `u969528706_una`.`c_estadoreservacion` (`id_estadoReservacion` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `u969528706_una`.`c_cabania` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `u969528706_una`.`c_asignacioncabania` (
  `id_reservacion` VARCHAR(45) NOT NULL ,
  ...
  CONSTRAINT `c_asignacionCabania_fk01`
    ...
    REFERENCES `u969528706_una`.`p_reservacion` (`id_reservacion` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `c_asignacionCabania_fk02`
    FOREIGN KEY (`id_cabania` )
    REFERENCES `u969528706_una`.`c_cabania` (`id_cabania` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `u969528706_una`.`c_asignacionreservacionactividad` (
  `id_reservacion` VARCHAR(45) NOT NULL ,
  ...
  CONSTRAINT `c_asignacionPaquete_fk02`
    ...
    REFERENCES `u969528706_una`.`c_actividad` (`id_actividad` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `u969528706_una`.`c_paquete` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `u969528706_una`.`c_asignacionpaqueteactividad` (
  ...
  CONSTRAINT `c_asignacionPaqueteActividad_fk01`
    ...
    REFERENCES `u969528706_una`.`c_paquete` (`id_paquete` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `u969528706_una`.`c_turista` (
  `id_usuario` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `u969528706_una`.`c_asignacionReservacionPaquete` (
  `id_reservacion` VARCHAR(45) NOT NULL ,
  `id_paquete` INT(11) NOT NULL ,

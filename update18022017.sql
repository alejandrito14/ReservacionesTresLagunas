...
CREATE SCHEMA IF NOT EXISTS `reservacion` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `reservacion` ;

-- -----------------------------------------------------
-- Table `reservacion`.`c_actividad`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `reservacion`.`c_actividad` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `reservacion`.`c_tipousuario` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `reservacion`.`c_usuario` (
  ...
  CONSTRAINT `c_usuario_fk01`
    ...
    REFERENCES `reservacion`.`c_tipousuario` (`id_tipoUsuario` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `reservacion`.`c_estadoreservacion` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `reservacion`.`p_reservacion` (
  ...
  CONSTRAINT `p_reservacion_fk01`
    ...
    REFERENCES `reservacion`.`c_usuario` (`id_usuario` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `p_reservacion_fk02`
    FOREIGN KEY (`id_estadoReservacion` )
    REFERENCES `reservacion`.`c_estadoreservacion` (`id_estadoReservacion` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `reservacion`.`c_cabania`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `reservacion`.`c_cabania` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `reservacion`.`c_asignacioncabania` (
  `id_asignacabania` INT NOT NULL AUTO_INCREMENT ,
  `id_reservacion` VARCHAR(45) NOT NULL ,
  `id_cabania` INT(11) NOT NULL ,
  PRIMARY KEY (`id_asignacabania`) ,
  ...
  CONSTRAINT `c_asignacionCabania_fk01`
    ...
    REFERENCES `reservacion`.`p_reservacion` (`id_reservacion` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `c_asignacionCabania_fk02`
    FOREIGN KEY (`id_cabania` )
    REFERENCES `reservacion`.`c_cabania` (`id_cabania` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `reservacion`.`c_asignacionreservacionactividad`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `reservacion`.`c_asignacionreservacionactividad` (
  `id_asignacionreservacionactividad` INT NOT NULL AUTO_INCREMENT ,
  `id_reservacion` VARCHAR(45) NOT NULL ,
  `id_actividad` INT(11) NOT NULL ,
  PRIMARY KEY (`id_asignacionreservacionactividad`) ,
  INDEX `c_asignacionReservacionActividad_fki01` (`id_actividad` ASC) ,
  INDEX `c_asignacionReservacionActividad_fki02` (`id_reservacion` ASC) ,
  CONSTRAINT `c_asignacionReservacionActividad_fk01`
    FOREIGN KEY (`id_reservacion` )
    REFERENCES `reservacion`.`p_reservacion` (`id_reservacion` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `c_asignacionReservacionActividad_fk02`
    FOREIGN KEY (`id_actividad` )
    REFERENCES `reservacion`.`c_actividad` (`id_actividad` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `reservacion`.`c_paquete` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `reservacion`.`c_asignacionpaqueteactividad` (
  ...
  CONSTRAINT `c_asignacionPaqueteActividad_fk01`
    ...
    REFERENCES `reservacion`.`c_paquete` (`id_paquete` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `reservacion`.`c_turista` (
  `id_usuario` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `reservacion`.`c_asignacionReservacionPaquete` (
  `id_asignacionReservacionPaquete` INT NOT NULL AUTO_INCREMENT ,
  `id_reservacion` VARCHAR(45) NOT NULL ,
  `id_paquete` INT(11) NOT NULL ,
  PRIMARY KEY (`id_asignacionReservacionPaquete`) ,

            ...
            <div class="main_container">
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a><i class="fa fa-edit"></i> Reservaciones <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                ...
                <div class="right_col" role="main">
                                        ...
                                        <div id="carousel" class="carousel slide"  data-ride="carousel">
                                            ...
                                            <div class="carousel-inner" role="listbox ">
                                                <div class="item active">
                                                    <img src="../Resource/img/caru4.jpg" alt="First slide">
                                                </div>
                                                <div class="item">
                                                    <img src="../Resource/img/caru3.jpg" alt="Second slide">
                                                </div>
                                                <div class="item">
                                                    <img src="../Resource/img/caru2.jpg" alt="Third slide">
                                                </div>
                                            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class=" col-sm-12 "> 
                                <center> <h3>Visita y Reserva en Centro Ecoturístico Tres Lagunas</h3>   </center> 
                    ...
                    <div class="container">
                        <div class="row">
                            <div class=" col-sm-12 "> 
                                <iframe width="1060" height="515" src="https://www.youtube.com/embed/wvt_H9rSMXs" frameborder="0" allowfullscreen></iframe>
                            </div>
                ...
                <footer>
                    <div class="pull-right">
                        Turista Template  <a href="https://colorlib.com">Colorlib</a>
                    </div>
                    <div class="clearfix"></div>
                </footer>
                <!-- /footer content -->

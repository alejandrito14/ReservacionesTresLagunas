...
if($tipo == 'pdf'){
    $idprotegido=$_GET["folio"];
      
      require_once 'lib/dompdf/dompdf_config.inc.php';

    $id=array('idprotegido'=>$idprotegido);
    $contexto=  stream_context_create($id);
    $dompdf = new DOMPDF();
    $dompdf->load_html( file_get_contents( 'Referencia.php',false,$contexto ) );
    $dompdf->render();
